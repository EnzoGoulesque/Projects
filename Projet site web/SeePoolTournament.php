...
<head>
    ...
    <script src="js/CheckEndPool.js"></script>
</head>

<?php include 'include/StartBracketP.php' ?>
<div id="cptM"><?php include 'include/GetAllTeamForSee.php' ?></div>
...
<body>
    <div id="main">
			...
			<div class="leftside">
				...
				<div class="buttonDiv" id="getWinner"><br/><br/></div>
