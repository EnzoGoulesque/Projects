            ...
            <div class="center">
                <article id="container">
                    ...
                    <section id="quarterFinals">
                        ...
                        <div id="2_match1_2"><span id="s_2_match1_2" class="score"></div>
                        <div id="2_match2_1"><span id="s_2_match2_1" class="score"></div>
                        <div id="2_match2_2"><span id="s_2_match2_2" class="score"></div>
                    </section>
                    ...
                    <section id="semiFinals">
                        <div id="3_match1_1"><span id="s_3_match1_1" class="score"></div>
                        <div id="3_match1_2"><span id="s_3_match1_2" class="score"></div>
                    </section>
                    ...
                    <section id="final">
                        <div id="4_match1_1"><span id="s_4_match1_1" class="score"></div>
                    </section>
                </article>       
